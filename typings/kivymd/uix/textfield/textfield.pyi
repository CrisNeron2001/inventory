...
class MDTextFieldRect(ThemableBehavior, TextInput):
    ...
    def anim_rect(self, points, alpha): # -> None:
        ...
...
class MDTextField(DeclarativeBehavior, ThemableBehavior, TextInput, Validator, AutoFormatTelephoneNumber):
    """
    Textfield class.
    ...
    def set_default_colors(self, interval: Union[float, int], updated: bool = ...) -> None:
        """
    ...
    def on_text_color_normal(self, instance_text_field, color: Union[list, str]) -> None:
        ...
    
    def on_hint_text_color_normal(self, instance_text_field, color: Union[list, str]) -> None:
        ...
    
    def on_helper_text_color_normal(self, instance_text_field, color: Union[list, str]) -> None:
        ...
    
    def on_icon_right_color_normal(self, instance_text_field, color: Union[list, str]) -> None:
        ...
    
    def on_line_color_normal(self, instance_text_field, color: Union[list, str]) -> None:
        ...
    
    def on_max_length_text_color(self, instance_text_field, color: Union[list, str]) -> None:
        ...
