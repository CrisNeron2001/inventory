...
from core.models.mapper.user_mapper import user_inv_dto_to_entity, user_inv_entity_to_dto
from core.models.mapper.role_mapper import role_entity_to_dto
...
def entity_to_dto(entity: Cart) -> CartDTO:
	...
	if entity.user_inv:
		try:
			...
			try:
				_role_obj = getattr(entity.user_inv, 'role_inv', None)
				_role_dto = role_entity_to_dto(_role_obj) if _role_obj is not None else None
				...
				user_dto = UserDTO(
					...
					first_name="",
					last_name="",
					username=getattr(entity.user_inv, 'username', str(entity.user_inv)),
					password="",
					created_at=None,
					updated_at=None,
					role_inv=_role_dto
