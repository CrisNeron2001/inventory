...
class ProductDetailController:
    ...
    def on_load_product_by_id(self, product_id: int) -> ft.Control:
        try:
            ...
            log.error(f"[ProductDetailController.on_load_product_by_id] Hubo problema al obtener el producto por id: {e}.")
            self.show_error_dialog([f"Hubo problema al obtener el producto por id: {str(e)}."])
            return ft.Container()
