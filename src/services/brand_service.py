...
class BrandService:
    ...
    def create_brand(self, brand_dto: BrandDTO) -> BrandDTO | None:
        ...
        log.info(f"[BrandService.create_brand] Creando una nueva marca: {new_brand}")
    ...
    def get_brand_by_id(self, brand_id: int) -> BrandDTO | None:
        ...
        log.info(f"[BrandService.get_brand_by_id] Obteniendo marca por id: {brand}")
        return entity_to_dto(brand) if brand else None
    
    def get_all_brands(self) -> List[BrandDTO]:
        brands = self.dao.get_all_brands()
        log.info(f"[BrandService.get_all_brands] Obteniendo todas las marcas: {brands}")
    ...
    def update_brand(self, brand_dto: BrandDTO) -> BrandDTO | None:
        ...
        log.info(f"[BrandService.update_brand] Modificando una marca: {updated_brand}")
    ...
    def delete_brand(self, brand_id: int) -> bool | None:
        ...
        log.info(f"[BrandService.delete_brand] Removiendo una marca : {brand}")
